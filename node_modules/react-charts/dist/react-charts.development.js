(function (global, factory) {
  ...
  const [utcTicks, utcTickInterval] = ticker(utcYear$1, utcMonth, utcSunday$1, utcDay$1, utcHour, utcMinute);
  const [timeTicks, timeTickInterval] = ticker(year$1, month, sunday$1, day$1, hour, minute);
  ...
  function time() {
    return initRange.apply(calendar(timeTicks, timeTickInterval, year$1, month, sunday$1, day$1, hour, minute, second, timeFormat$1).domain([new Date(2000, 0, 1), new Date(2000, 0, 2)]), arguments);
  }

  function utcTime() {
    return initRange.apply(calendar(utcTicks, utcTickInterval, utcYear$1, utcMonth, utcSunday$1, utcDay$1, utcHour, utcMinute, second, utcFormat$1).domain([Date.UTC(2000, 0, 1), Date.UTC(2000, 0, 2)]), arguments);
  }
  ...
  function useRect(element, enabled) {
    var rerender = React__default['default'].useReducer(function () {
      return {};
    }, [])[1];
    var rectRef = React__default['default'].useRef({
      width: 0,
      height: 0,
      x: 0,
      y: 0,
  ...
  function Chart(_ref) {
    ...
    }), options.useIntersectionObserver && !isIntersecting ? null : /*#__PURE__*/React__default['default'].createElement(ChartInner, {
      options: options,
      width: width,
      height: height
    }));
